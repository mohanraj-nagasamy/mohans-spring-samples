...
org.openid4java.discovery.DiscoveryInformation, 
 org.openid4java.message.ax.*, org.openid4java.message.sreg.*,  
...
<%
    ...
    String openid=request.getParameter("openid");
        ...
        try
        {
            ...
            fetch.addAttribute("firstname", "http://axschema.org/namePerson/first", true,1);
            //YAHOO
           	//fetch.addAttribute("firstname", "http://axschema.org/namePerson", true,1);
           	//fetch.addAttribute("namePerson", "http://axschema.org/namePerson", true,1);
           
            fetch.addAttribute("LastName", "http://axschema.org/namePerson/last", true,1);
...
<%
                ...
                while (keyit.hasNext())
                {
                    ...
                    value=pm.get(key);
            %>
        <input size="200" type="text" name="<%= key%>" value="<%= value%>"/> </br>
        <%
                }
        %>
